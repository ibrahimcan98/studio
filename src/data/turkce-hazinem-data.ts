...
export const CHESTS_CONTENT: Record<string, ChestContent> = {
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            ...
            {
              q: "Atatürk sadece okul yıllarında kitap okumuştur.",
              correct: false,
            },
        ...
        },
        {
          ...
          sentences: [
            {
              text: "Atatürk hayatı boyunca {blank} devam etti.",
              answer: "öğrenmeye",
              options: ["öğrenmeye", "notlar", "düşünmesine", "önem"],
            },
            {
              text: "Okuduğu kitaplardan {blank} alırdı.",
              answer: "notlar",
              options: ["öğrenmeye", "notlar", "düşünmesine", "önem"],
            },
            {
              text: "Kitaplar insanın {blank} yardım eder.",
              answer: "düşünmesine",
              options: ["öğrenmeye", "notlar", "düşünmesine", "önem"],
            },
            {
              text: "Atatürk öğrenmeye {blank} verirdi.",
              answer: "önem",
              options: ["öğrenmeye", "notlar", "düşünmesine", "önem"],
            },
          ],
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            {
              q: "Ali",
              options: ["Kişi adı", "Eşya adı", "Şehir adı"],
              correct: 0,
            },
            {
              q: "Kedi",
              options: ["Kişi adı", "Hayvan adı", "Ülke adı"],
              correct: 1,
            },
            {
              q: "İstanbul",
              options: ["Hayvan adı", "Şehir adı", "Duygu adı"],
              correct: 1,
            },
            {
              q: "Türkiye",
              options: ["Ülke adı", "Kişi adı", "Eşya adı"],
              correct: 0,
            },
            {
              q: "Kalem",
              options: ["Kişi adı", "Eşya adı", "Ülke adı"],
              correct: 1,
            },
            {
              q: "Sevinç",
              options: ["Şehir adı", "Hayvan adı", "Duygu adı"],
              correct: 2,
            },
            {
              q: "Pamuk",
              options: ["Kişi adı", "Hayvana verilen özel ad", "Eşya adı"],
              correct: 1,
            },
            {
              q: "Ankara",
              options: ["Şehir adı", "Ülke adı", "Kişi adı"],
              correct: 0,
            },
          ],
        },
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            ...
            {
              q: "30 Ağustos sadece oyun ve eğlence bayramıdır.",
              correct: false,
            },
            {
              q: "Zafer, birlikte çalışmanın ve kararlılığın sonucu olabilir.",
              correct: true,
            },
            {
              q: "30 Ağustos bağımsızlık mücadelesiyle bağlantılıdır.",
              correct: true,
            },
        ...
        },
        {
          ...
          sentences: [
            {
              text: "30 Ağustos {blank} Bayramı’dır.",
              answer: "Zafer",
              options: ["Zafer", "kararlarını", "kararlılık", "birlik"],
            },
            {
              text: "Bağımsızlık, bir ülkenin kendi {blank} kendisinin verebilmesidir.",
              answer: "kararlarını",
              options: ["Zafer", "kararlarını", "kararlılık", "birlik"],
            },
            {
              text: "Zafer; emek, birlik ve {blank} ile kazanılır.",
              answer: "kararlılık",
              options: ["Zafer", "kararlarını", "kararlılık", "birlik"],
            },
            {
              text: "30 Ağustos bize {blank} olmanın önemini anlatır.",
              answer: "birlik",
              options: ["Zafer", "kararlarını", "kararlılık", "birlik"],
            },
          ],
      ...
      activities: [
        ...
        },
        {
          ...
          options: [
            ...
            {
              text: "İstanbul, Asya ve Avrupa kıtaları arasında özel bir konuma sahiptir.",
              isCorrect: true,
            },
            {
              text: "Marmara Bölgesi Türkiye’nin en doğusunda yer alır.",
              isCorrect: false,
            },
            {
              text: "Bölgede İstanbul, Bursa, Edirne ve Çanakkale gibi şehirler bulunur.",
              isCorrect: true,
            },
            {
              text: "Marmara Bölgesi’nin denizle hiçbir bağlantısı yoktur.",
              isCorrect: false,
            },
          ],
        },
        {
          ...
          sentences: [
            {
              text: "Marmara Bölgesi Türkiye’nin {blank} yer alır.",
              answer: "kuzeybatısında",
              options: ["kuzeybatısında", "Avrupa", "bağlar", "hareketli"],
            },
            {
              text: "İstanbul Boğazı Asya ve {blank} kıtalarını ayırır.",
              answer: "Avrupa",
              options: ["kuzeybatısında", "Avrupa", "bağlar", "hareketli"],
            },
            {
              text: "Köprüler iki yakayı birbirine {blank} .",
              answer: "bağlar",
              options: ["kuzeybatısında", "Avrupa", "bağlar", "hareketli"],
            },
            {
              text: "Marmara Bölgesi kalabalık ve {blank} bir bölgedir.",
              answer: "hareketli",
              options: ["kuzeybatısında", "Avrupa", "bağlar", "hareketli"],
            },
          ],
    ...
    dilimiOgreniyorum: {
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            {
              q: "............... elma masada duruyor.",
              options: ["Kırmızı", "Koştu"],
              correct: 0,
            },
            {
              q: "............... masa sınıfın ortasında.",
              options: ["Yuvarlak", "Uyudu"],
              correct: 0,
            },
            {
              q: "............... oda çok güzel kokuyor.",
              options: ["Temiz", "Geldi"],
              correct: 0,
            },
            {
    ...
    ulkemiOgreniyorum: {
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            {
              q: "Türk kültüründe misafire ikram etmek önemlidir.",
              correct: true,
            },
            {
              q: "Simit ve çay günlük hayatta sık görülebilir.",
              correct: true,
            },
            { q: "Baklava geleneksel tatlılardan biridir.", correct: true },
            {
              q: "Türk kahvesi büyük çorba kaselerinde içilir.",
              correct: false,
            },
    ...
    dilimiOgreniyorum: {
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            {
              q: "Hangi kelime eylemdir?",
              options: ["Çanta", "Koştu", "Kalem"],
              correct: 1,
            },
            {
              q: "Hangi kelime eylemdir?",
              options: ["Yıkadı", "Sabun", "Masa"],
              correct: 0,
            },
            {
              q: "Hangi kelime eylemdir?",
              options: ["Kedi", "Uyudu", "Kapı"],
              correct: 1,
            },
            {
              q: "Hangi kelime eylemdir?",
              options: ["Okudu", "Defter", "Sarı"],
              correct: 0,
            },
            {
              q: "Hangi kelime eylemdir?",
              options: ["Çiçek", "Suladı", "Saksı"],
              correct: 1,
            },
          ],
        },
    ...
    ulkemiOgreniyorum: {
      ...
      activities: [
        ...
        },
        {
          ...
          images: [
            {
              src: "/turkce-hazinem/16.zeytin.png",
              label: "Zeytin",
              isCorrect: true,
            },
            {
              src: "/turkce-hazinem/16.incir.png",
              label: "İncir",
              isCorrect: true,
            },
            {
              src: "/turkce-hazinem/16.cay.png",
              label: "Çay",
              isCorrect: false,
            },
            {
              src: "/turkce-hazinem/16.muz.png",
              label: "Muz",
              isCorrect: false,
            },
            {
              src: "/turkce-hazinem/16.findik.png",
              label: "Fındık",
              isCorrect: false,
            },
          ],
    ...
    ulkemiOgreniyorum: {
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            {
              q: "Saklambaçta saklanan kişiler bulunmaya çalışılır.",
              correct: true,
            },
            {
              q: "Seksek yere çizilen kutular üzerinde oynanabilir.",
              correct: true,
            },
            {
              q: "Bayramlaşma kültürümüzde yer alan bir gelenektir.",
              correct: true,
            },
            {
              q: "Mendil kapmaca sadece kitap okuyarak oynanır.",
              correct: false,
            },
            {
              q: "Oyunlar çocukların birlikte eğlenmesine yardım eder.",
              correct: true,
            },
          ],
        },
      ...
      activities: [
        {
          ...
          questions: [
            {
              q: "Elma",
              options: ["kırmızı", "yuvarlak", "keskin"],
              correct: 2,
            },
            {
              q: "Pamuk",
              options: ["yumuşak", "gürültülü", "beyaz"],
              correct: 1,
            },
            ...
            {
              q: "Kedi",
              options: ["tüylü", "kanatlı", "miyavlayan"],
              correct: 1,
            },
            ...
            {
              q: "Çanta",
              options: ["taşınabilir", "koklayan", "eşya koyulan"],
              correct: 1,
            },
          ],
        },
    ...
    ulkemiOgreniyorum: {
      ...
      activities: [
        ...
        },
        {
          ...
          sentences: [
            {
              text: "Planlı olmak, yapılacak işleri önceden {blank} demektir.",
              answer: "düşünmek",
              options: ["düşünmek", "yapmaya", "vazgeçmemek", "önemseyerek"],
            },
            {
              text: "Cesaret, zor durumda bile doğru olanı {blank} çalışmaktır.",
              answer: "yapmaya",
              options: ["düşünmek", "yapmaya", "vazgeçmemek", "önemseyerek"],
            },
            {
              text: "Kararlılık, hedefinden kolayca {blank} demektir.",
              answer: "vazgeçmemek",
              options: ["düşünmek", "yapmaya", "vazgeçmemek", "önemseyerek"],
            },
            {
              text: "Sorumluluk, bir görevi {blank} yerine getirmektir.",
              answer: "önemseyerek",
              options: ["düşünmek", "yapmaya", "vazgeçmemek", "önemseyerek"],
            },
          ],
    ...
    dilimiOgreniyorum: {
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            {
              q: "Kitap kelimesine lık gelirse ne olur?",
              options: ["Kitaplık", "Kitapçı"],
              correct: 0,
            },
            {
              q: "Çiçek satan kişiye ne denir?",
              options: ["Çiçekçi", "Çiçeklik"],
              correct: 0,
            },
            {
              q: "İçinde şeker olan çay nasıldır?",
              options: ["Şekerli", "Şekersiz"],
              correct: 0,
            },
            {
              q: "İçinde tuz olmayan yemek nasıldır?",
              options: ["Tuzlu", "Tuzsuz"],
              correct: 1,
            },
            {
              q: "Su koyduğumuz kaba ne denir?",
              options: ["Suluk", "Sucu"],
              correct: 0,
            },
          ],
        },
        {
          ...
          sentences: [
            {
              text: "Kalemlik {blank}",
              answer: "Kalem konulan kutu",
              options: [
                "Kalem konulan kutu",
                "Kitap satan kişi",
                "İçinde şeker olmayan",
                "Tuz koyulan kap",
                "Balık tutan ya da satan kişi",
              ],
            },
            {
              text: "Kitapçı {blank}",
              answer: "Kitap satan kişi",
              options: [
                "Kalem konulan kutu",
                "Kitap satan kişi",
                "İçinde şeker olmayan",
            ...
            {
              text: "Balıkçı {blank}",
              answer: "Balık tutan ya da satan kişi",
              options: [
                "Kalem konulan kutu",
                "Kitap satan kişi",
                "İçinde şeker olmayan",
        ...
        },
        {
          ...
          questions: [
            {
              q: "Kitap satan kişi: kitap...............",
              options: ["çı", "lık"],
              correct: 0,
            },
            {
              q: "Kalem koyulan kutu: kalem...............",
              options: ["lik", "ci"],
              correct: 0,
            },
            {
              q: "Şekeri olmayan çay: şeker...............",
              options: ["siz", "li"],
              correct: 0,
            },
            {
              q: "Tuzu olan çorba: tuz...............",
              options: ["lu", "luk"],
              correct: 0,
            },
            {
              q: "Gözümüze taktığımız araç: göz...............",
              options: ["lük", "cü"],
              correct: 0,
            },
          ],
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            ...
            {
              q: "Toros Dağları Akdeniz Bölgesi ile bağlantılıdır.",
              correct: true,
            },
            {
              q: "Akdeniz Bölgesi’nde yazlar genellikle soğuk ve karlıdır.",
              correct: false,
            },
            {
              q: "Antalya Akdeniz Bölgesi’nin önemli şehirlerindendir.",
              correct: true,
            },
          ],
        },
  ...
  "20": {
    ...
    dilimiOgreniyorum: {
      ...
      activities: [
        ...
        },
        {
          ...
          sentences: [
            {
              text: "Ali koştu. Kim koştu? {blank}",
              answer: "Ali",
              options: ["Ali", "Elif", "Kuş", "Kedi", "Öğretmen"],
            },
            {
              text: "Elif kitap okudu. Kim okudu? {blank}",
              answer: "Elif",
              options: ["Ali", "Elif", "Kuş", "Kedi", "Öğretmen"],
            },
            {
              text: "Kuş uçtu. Ne uçtu? {blank}",
              answer: "Kuş",
              options: ["Ali", "Elif", "Kuş", "Kedi", "Öğretmen"],
            },
            {
              text: "Kedi uyudu. Ne uyudu? {blank}",
              answer: "Kedi",
              options: ["Ali", "Elif", "Kuş", "Kedi", "Öğretmen"],
            },
            {
              text: "Öğretmen anlattı. Kim anlattı? {blank}",
              answer: "Öğretmen",
              options: ["Ali", "Elif", "Kuş", "Kedi", "Öğretmen"],
            },
          ],
        },
        {
          ...
          sentences: [
            {
              text: "Ali koştu. Ne yaptı? {blank}",
              answer: "Koştu",
              options: ["Koştu", "Okudu", "Uçtu", "Uyudu", "Yaptı"],
            },
            {
              text: "Elif kitap okudu. Ne yaptı? {blank}",
              answer: "Okudu",
              options: ["Koştu", "Okudu", "Uçtu", "Uyudu", "Yaptı"],
            },
            {
              text: "Kuş uçtu. Ne yaptı? {blank}",
              answer: "Uçtu",
              options: ["Koştu", "Okudu", "Uçtu", "Uyudu", "Yaptı"],
            },
            {
              text: "Kedi uyudu. Ne yaptı? {blank}",
              answer: "Uyudu",
              options: ["Koştu", "Okudu", "Uçtu", "Uyudu", "Yaptı"],
            },
            {
        ...
        },
        {
          ...
          questions: [
            {
              q: "............... kitap okudu.",
              options: ["Elif", "Kırmızı"],
              correct: 0,
            },
            { q: "Kuş ...............", options: ["uçtu", "mavi"], correct: 0 },
            {
              q: "Öğretmen ...............",
              options: ["anlattı", "masa"],
              correct: 0,
            },
            {
              q: "............... süt içti.",
    ...
    ulkemiOgreniyorum: {
      title:
        "Sandık 20: Sayıların ve Bilimin Ustaları: Harezmi, Cahit Arf ve Aziz Sancar",
      activities: [
        {
          type: "info",
        ...
        },
        {
          ...
          sentences: [
            {
              text: "Harezmi {blank} alanındaki çalışmalarıyla bilinir.",
              answer: "matematik",
              options: ["matematik", "matematikçi", "Nobel", "aramakla"],
            },
            {
              text: "Cahit Arf önemli bir {blank} idi.",
              answer: "matematikçi",
              options: ["matematik", "matematikçi", "Nobel", "aramakla"],
            },
            {
              text: "Aziz Sancar {blank} Kimya Ödülü almıştır.",
              answer: "Nobel",
              options: ["matematik", "matematikçi", "Nobel", "aramakla"],
            },
            {
              text: "Bilim, soru sormak ve cevap {blank} başlar.",
              answer: "aramakla",
              options: ["matematik", "matematikçi", "Nobel", "aramakla"],
            },
          ],
    ...
    dilimiOgreniyorum: {
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            {
              q: "Ali sabah okula gitti. Ne zaman gitti?",
              options: ["Sabah", "Okula"],
              correct: 0,
            },
            {
              q: "Elif bahçede oyun oynadı. Nerede oynadı?",
              options: ["Bahçede", "Oyun"],
              correct: 0,
            },
            {
              q: "Mert dikkatlice kitabını okudu. Nasıl okudu?",
              options: ["Dikkatlice", "Kitabını"],
              correct: 0,
            },
            {
              q: "Zeynep hasta olduğu için okula gitmedi. Neden okula gitmedi?",
              options: ["Hasta olduğu için", "Okula"],
              correct: 0,
            },
            {
              q: "Kerem akşam dişlerini fırçaladı. Ne zaman fırçaladı?",
              options: ["Akşam", "Dişlerini"],
              correct: 0,
            },
          ],
        },
        ...
        },
        {
          ...
          questions: [
            {
              q: "Ne zaman? Ali ............... parka gitti.",
              options: ["sabah", "dikkatlice"],
              correct: 0,
            },
            {
              q: "Nerede? Elif ............... kitap okudu.",
              options: ["kütüphanede", "yavaşça"],
              correct: 0,
            },
            {
              q: "Nasıl? Mert kapıyı ............... kapattı.",
              options: ["sessizce", "dün"],
              correct: 0,
            },
            {
              q: "Neden? Ayşe ............... dışarı çıkmadı.",
              options: ["yağmur yağdığı için", "bahçede"],
              correct: 0,
            },
            {
              q: "Ne zaman? Kedi ............... uyudu.",
              options: ["gece", "hızlıca"],
              correct: 0,
            },
          ],
        },
        {
          ...
          questions: [
            {
              q: "Çocuklar sınıfta resim yaptı.",
              options: ["Nerede?", "Neden?"],
              correct: 0,
            },
            {
              q: "Dün annemle markete gittim.",
              options: ["Ne zaman?", "Nasıl?"],
              correct: 0,
            },
            {
              q: "Kuş yavaşça dala kondu.",
              options: ["Nasıl?", "Nerede?"],
              correct: 0,
            },
            {
              q: "Hasta olduğu için dinlendi.",
              options: ["Neden?", "Ne zaman?"],
              correct: 0,
            },
            {
              q: "Sabah kahvaltı yaptım.",
              options: ["Ne zaman?", "Nerede?"],
              correct: 0,
            },
          ],
        },
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            ...
            {
              q: "Buğday ve arpa İç Anadolu’da yetişen ürünlerdendir.",
              correct: true,
            },
            {
              q: "Kapadokya ve Peri Bacaları İç Anadolu ile bağlantılıdır.",
              correct: true,
            },
            {
              q: "Bozkır İç Anadolu’da görülebilen bitki örtüsüdür.",
              correct: true,
            },
          ],
        },
    ...
    dilimiOgreniyorum: {
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            {
              q: "Elif sabah erkenden uyandı. Kahvaltısını yaptı. Sonra ...............",
              options: ["okula gitti.", "dün geldi."],
              correct: 0,
            },
            {
              q: "Mert oyuncaklarını yere döktü. Oyun oynadı. Sonra ...............",
              options: ["oyuncaklarını topladı.", "sabah oldu."],
              correct: 0,
            },
            {
              q: "Nil kapıda ıslak bir kedi gördü. Ona kutu hazırladı. Sonra ...............",
              options: ["kediyi güvenli yere aldı.", "kalemini açtı."],
              correct: 0,
            },
            {
              q: "Pelin cüzdan buldu. Öğretmenine götürdü. Sonra ...............",
              options: ["cüzdanın sahibi bulundu.", "uçurtma aldı."],
              correct: 0,
            },
            {
              q: "Efe bilgi kartı yazdı. Sandığa bıraktı. Sonra ...............",
              options: ["arkadaşlarının kartlarını okudu.", "toprağı kazdı."],
              correct: 0,
            },
          ],
        },
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            ...
            {
              q: "Anıtkabir Atatürk’ün anısını yaşatan özel bir yerdir.",
              correct: true,
            },
            {
              q: "Atatürk’ü anmak, onun hayatını ve çalışmalarını öğrenmekle de ilgilidir.",
              correct: true,
            },
            { q: "Anıtkabir bir lunaparktır.", correct: false },
            {
              q: "Anıtkabir saygı ve hatırlama duygusunu temsil eder.",
              correct: true,
            },
          ],
        },
        {
          ...
          sentences: [
            {
              text: "Anıtkabir {blank} şehrindedir.",
              answer: "Ankara",
              options: ["Ankara", "yaşatan", "öğrenmek", "hatırlama"],
            },
            {
              text: "Anıtkabir, Atatürk’ün anısını {blank} özel bir yerdir.",
              answer: "yaşatan",
              options: ["Ankara", "yaşatan", "öğrenmek", "hatırlama"],
            },
            {
              text: "Atatürk’ü anmak, onun hayatını ve çalışmalarını {blank} demektir.",
              answer: "öğrenmek",
              options: ["Ankara", "yaşatan", "öğrenmek", "hatırlama"],
            },
            {
              text: "Anıtkabir saygı ve {blank} duygusunu temsil eder.",
              answer: "hatırlama",
              options: ["Ankara", "yaşatan", "öğrenmek", "hatırlama"],
            },
          ],
    ...
    dilimiOgreniyorum: {
      ...
      activities: [
        ...
        },
        {
          ...
          sentences: [
            {
              text: "Kulak misafiri olmak {blank}",
              answer: "Bir konuşmayı istemeden duymak",
              options: [
            ...
            {
              text: "Ağzı kulaklarına varmak {blank}",
              answer: "Çok mutlu olmak",
              options: [
                "Bir konuşmayı istemeden duymak",
                "Çok sevinmek",
                "Çok mutlu olmak",
            ...
            {
              text: "Gözü gibi bakmak {blank}",
              answer: "Çok dikkatli korumak",
              options: [
                "Bir konuşmayı istemeden duymak",
                "Çok sevinmek",
                "Çok mutlu olmak",
            ...
            {
              text: "Eli ayağına dolaşmak {blank}",
              answer: "Heyecandan ne yapacağını şaşırmak",
              options: [
                "Bir konuşmayı istemeden duymak",
                "Çok sevinmek",
                "Çok mutlu olmak",
        ...
        },
        {
          ...
          sentences: [
            {
              text: "Hediyeyi görünce etekleri zil çaldı. Deyim: {blank}",
            ...
            {
              text: "Yeni bisikletine gözü gibi bakıyor. Deyim: {blank}",
              answer: "gözü gibi bakmak",
              options: [
                "etekleri zil çalmak",
                "gözü gibi bakmak",
                "kulak misafiri olmak",
            ...
            {
              text: "Öğretmenin konuşmasına kulak misafiri oldum. Deyim: {blank}",
              answer: "kulak misafiri olmak",
              options: [
                "etekleri zil çalmak",
                "gözü gibi bakmak",
                "kulak misafiri olmak",
            ...
            {
              text: "Sahnede eli ayağına dolaştı. Deyim: {blank}",
              answer: "eli ayağına dolaşmak",
              options: [
                "etekleri zil çalmak",
                "gözü gibi bakmak",
                "kulak misafiri olmak",
            ...
            {
              text: "Haberi alınca ağzı kulaklarına vardı. Deyim: {blank}",
              answer: "ağzı kulaklarına varmak",
              options: [
                "etekleri zil çalmak",
                "gözü gibi bakmak",
                "kulak misafiri olmak",
        ...
        },
        {
          ...
          questions: [
            {
              q: "“Gözü gibi bakmak” ne demektir?",
              options: ["Çok dikkatli korumak", "Gözle bakmak"],
              correct: 0,
            },
            {
            ...
            {
              q: "“Ağzı kulaklarına varmak” ne demektir?",
              options: ["Çok mutlu olmak", "Konuşmamak"],
              correct: 0,
            },
            {
              q: "“Kulak misafiri olmak” ne demektir?",
              options: ["İstemeden duymak", "Misafirliğe gitmek"],
              correct: 0,
            },
            {
              q: "“Etekleri zil çalmak” ne demektir?",
              options: ["Çok sevinmek", "Zil takmak"],
              correct: 0,
            },
          ],
        },
    ...
    ulkemiOgreniyorum: {
      ...
      activities: [
        ...
        },
        {
          ...
          sentences: [
            {
              text: "Cumhuriyet {blank} Ekim 1923’te ilan edilmiştir.",
              answer: "29",
              options: ["29", "söz", "Bayramı", "başlangıcı"],
            },
            {
              text: "Cumhuriyet, halkın yönetimde {blank} sahibi olmasıdır.",
              answer: "söz",
              options: ["29", "söz", "Bayramı", "başlangıcı"],
            },
            {
              text: "29 Ekim, Cumhuriyet {blank} olarak kutlanır.",
              answer: "Bayramı",
              options: ["29", "söz", "Bayramı", "başlangıcı"],
            },
            {
        ...
        },
        {
          ...
          questions: [
            ...
            {
              q: "Cumhuriyet halkın yönetimde söz sahibi olmasıyla ilgilidir.",
              correct: true,
            },
            {
              q: "29 Ekim sadece denizlerimizi anlatan bir gündür.",
              correct: false,
            },
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            ...
            {
              q: "Bir elin nesi var, iki elin ............... var.",
              options: ["sesi", "rengi"],
              correct: 0,
            },
            {
              q: "Sakla samanı, gelir ...............",
              options: ["zamanı", "oyunu"],
              correct: 0,
            },
            {
              q: "Ak akçe kara gün ...............",
              options: ["içindir", "dışındadır"],
              correct: 0,
            },
            {
              q: "Üzüm üzüme baka baka ...............",
              options: ["kararır", "konuşur"],
              correct: 0,
            },
            {
              q: "İşleyen demir pas ...............",
              options: ["tutmaz", "toplar"],
              correct: 0,
            },
            {
              q: "Tatlı dil yılanı deliğinden ...............",
              options: ["çıkarır", "saklar"],
              correct: 0,
            },
          ],
        },
        {
          ...
          questions: [
            ...
            },
            {
              ...
              options: [
                "Birlikte çalışmak daha etkilidir.",
                "Tek başına çalışmak her zaman daha iyidir.",
              ],
              correct: 0,
            },
            {
              ...
              options: [
                "Gereksiz görünen şeyler bir gün işe yarayabilir.",
                "Her şeyi hemen atmak gerekir.",
              ],
              correct: 0,
            },
            {
              ...
              options: [
                "Zor zamanlar için birikim yapmak gerekir.",
                "Para hiç önemli değildir.",
              ],
              correct: 0,
            },
            {
              q: "Üzüm üzüme baka baka kararır.",
              options: [
                "İnsanlar çevresindeki kişilerden etkilenebilir.",
                "Üzüm sadece karanlıkta yetişir.",
              ],
              correct: 0,
            },
            {
              q: "İşleyen demir pas tutmaz.",
              options: [
                "Çalışan ve kendini geliştiren kişi güçlü kalır.",
                "Hiç çalışmayan kişi daha çok gelişir.",
              ],
              correct: 0,
            },
            {
        ...
        },
        {
          ...
          sentences: [
            {
              text: "Küçük birikimler zamanla büyür. -> {blank}",
              answer: "Damlaya damlaya göl olur.",
            },
            {
              text: "Alışkanlıklar küçük yaşta daha kolay kazanılır. -> {blank}",
              answer: "Ağaç yaşken eğilir.",
            },
            {
              text: "Birlikte çalışmak işleri kolaylaştırır. -> {blank}",
              answer: "Bir elin nesi var, iki elin sesi var.",
            },
            {
              text: "Bugün gereksiz görünen şey ileride işe yarayabilir. -> {blank}",
              answer: "Sakla samanı, gelir zamanı.",
            },
            {
              text: "Zor zamanlar için birikim yapmak gerekir. -> {blank}",
              answer: "Ak akçe kara gün içindir.",
            },
            {
              text: "İnsan çevresindeki kişilerden etkilenebilir. -> {blank}",
              answer: "Üzüm üzüme baka baka kararır.",
            },
            {
              text: "Çalışan ve öğrenmeye devam eden kişi gelişir. -> {blank}",
              answer: "İşleyen demir pas tutmaz.",
            },
            {
              text: "Nazik konuşmak sorunları çözmeye yardım eder. -> {blank}",
              answer: "Tatlı dil yılanı deliğinden çıkarır.",
            },
          ],
          words: [
            "Damlaya damlaya göl olur.",
    ...
    dilimiOgreniyorum: {
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            {
              q: "Metin ağaçların canlılara yuva olduğunu anlatıyor.",
              options: ["Ağaçlar", "Oyuncaklar", "Trafik kuralları"],
              correct: 0,
            },
            {
              q: "Metin kitap okumanın faydalarını anlatıyor.",
              options: ["Spor yapmak", "Kitap okumak", "Yemek yapmak"],
              correct: 1,
            },
            {
              q: "Metin çöpleri geri dönüşüme atmayı anlatıyor.",
              options: ["Geri dönüşüm", "Müzik dinlemek", "Tatil planı"],
              correct: 0,
            },
            {
              q: "Metin yeni gelen bir arkadaşla empati kurmayı anlatıyor.",
              options: ["Alışveriş", "Empati", "Hava durumu"],
              correct: 1,
            },
            {
              q: "Metin güneş enerjisiyle çalışan bir oyuncağı anlatıyor.",
              options: [
                "Güneş enerjisi",
                "Hayvan sevgisi",
                "Masal kahramanları",
        ...
        },
        {
          ...
          questions: [
            {
              q: "Bir çocuk çöpleri yerden alıp geri dönüşüm kutusuna atıyor.",
              options: [
                "Çevremizi temiz tutmalıyız.",
                "Çöpler yerde kalmalıdır.",
              ],
              correct: 0,
            },
            {
              q: "Bir çocuk oyuncaklarını topluyor ve odası düzenleniyor.",
              options: [
                "Eşyaları yerine koymak yaşamı kolaylaştırır.",
                "Oyuncaklar kaybolmalıdır.",
              ],
              correct: 0,
            },
            {
              q: "Bir çocuk yeni arkadaşına resim yaparak yaklaşır.",
              options: [
                "Küçük bir iyilik arkadaşlığı başlatabilir.",
                "Yeni arkadaşlarla konuşmamalıyız.",
              ],
              correct: 0,
            },
            {
              q: "Bir çocuk korktuğu gölgenin ne olduğunu araştırır.",
              options: [
                "Korktuğumuz şeyi anlamaya çalışmak bizi rahatlatabilir.",
                "Her gölge tehlikelidir.",
              ],
              correct: 0,
            },
            {
              q: "Bir çocuk bilgi kartını sandığa koyar.",
              options: [
                "Öğrendiğimiz bilgileri paylaşmak değerlidir.",
                "Bilgi saklanmalıdır.",
              ],
              correct: 0,
            },
  ...
  "26": {
      ...
      activities: [
        {
          ...
          questions: [
            {
              q: "Ali sabah bahçede top oynadı. (Kim top oynadı?)",
              options: ["Sabah", "Ali", "Bahçede"],
              correct: 1,
            },
            {
              q: "Elif okulda kitap okudu. (Nerede kitap okudu?)",
              options: ["Okulda", "Kitap", "Elif"],
              correct: 0,
            },
            {
              q: "Mert akşam dişlerini fırçaladı. (Ne zaman fırçaladı?)",
              options: ["Dişlerini", "Mert", "Akşam"],
              correct: 2,
            },
            {
              q: "Zeynep hasta olduğu için okula gitmedi. (Neden okula gitmedi?)",
              options: ["Hasta olduğu için", "Okula", "Zeynep"],
              correct: 0,
            },
            {
              q: "Kerem sessizce kapıyı kapattı. (Nasıl kapattı?)",
              options: ["Kapıyı", "Sessizce", "Kerem"],
              correct: 1,
            },
            {
              q: "Çocuklar parkta oyun oynadı. (Nerede oyun oynadı?)",
              options: ["Çocuklar", "Oyun", "Parkta"],
              correct: 2,
            },
            {
              q: "Annem pazardan elma aldı. (Ne aldı?)",
              options: ["Elma", "Pazardan", "Annem"],
              correct: 0,
            },
            {
              q: "Yağmur yağdığı için pikniğe gidemedik. (Neden pikniğe gidemedik?)",
              options: ["Pikniğe", "Yağmur yağdığı için", "Gidemedik"],
              correct: 1,
            },
          ],
        },
    ...
    ulkemiOgreniyorum: {
      title:
        "Sandık 26: Yıldızlara Bakanlar: Nüzhet Gökdoğan, Dilhan Eryurt ve Feryal Özel",
      activities: [
        {
          type: "info",
        ...
        },
        {
          ...
          sentences: [
            {
              text: "Astronomi {blank} ve uzayı inceleyen bilim dalıdır.",
              answer: "gökyüzünü",
              options: ["gökyüzünü", "yıldızlar", "delikler", "başlangıcı"],
            },
            {
              text: "Dilhan Eryurt Güneş ve {blank} üzerine çalışmıştır.",
              answer: "yıldızlar",
              options: ["gökyüzünü", "yıldızlar", "delikler", "başlangıcı"],
            },
            {
              text: "Feryal Özel kara {blank} ile ilgili çalışmalarıyla tanınır.",
              answer: "delikler",
              options: ["gökyüzünü", "yıldızlar", "delikler", "başlangıcı"],
            },
            {
              text: "Gökyüzüne merakla bakmak bilimin güzel bir {blank} olabilir.",
              answer: "başlangıcı",
              options: ["gökyüzünü", "yıldızlar", "delikler", "başlangıcı"],
            },
          ],
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            ...
            {
              q: "Sıcak bir gülümsemesi vardı.",
              options: ["Gerçek anlam", "Mecaz anlam"],
              correct: 1,
            },
            {
              q: "Elim soğuk suya değdi.",
              options: ["Gerçek anlam", "Mecaz anlam"],
              correct: 0,
            },
            {
              q: "Bana soğuk davrandı.",
              options: ["Gerçek anlam", "Mecaz anlam"],
              correct: 1,
            },
            {
              q: "Ağır çantayı taşıdı.",
              options: ["Gerçek anlam", "Mecaz anlam"],
              correct: 0,
            },
          ],
        },
        {
          ...
          questions: [
            {
              q: "“Sıcak karşıladı” ne demektir?",
              options: ["Samimi davrandı", "Ateş yaktı"],
              correct: 0,
            },
            {
              q: "“Soğuk davrandı” ne demektir?",
              options: ["İlgisiz davrandı", "Üşüdü"],
              correct: 0,
            },
            {
              q: "“Ağır söz söyledi” ne demektir?",
              options: ["Kırıcı söz söyledi", "Taş taşıdı"],
              correct: 0,
            },
            {
              q: "“Tatlı bir çocuk” ne demektir?",
              options: ["Sevimli çocuk", "Şekerden yapılmış çocuk"],
              correct: 0,
            },
            {
              q: "“Karanlık düşünceler” ne demektir?",
              options: ["Üzücü ya da kötü düşünceler", "Lambası olmayan oda"],
              correct: 0,
            },
          ],
        },
    ...
    dilimiOgreniyorum: {
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            {
              q: "______ elma masada duruyor.",
              options: ["Kırmızı", "Uyuyan", "Koşan"],
              correct: 0,
            },
            {
              q: "______ kutu yerdeydi.",
              options: ["Büyük", "Okuyan", "Uçan"],
              correct: 0,
            },
            {
              q: "______ kuş ağaca kondu.",
              options: ["Küçük", "Tatlı", "Sulu"],
              correct: 0,
            },
            {
              q: "______ kalem çantamda.",
              options: ["Mavi", "Hızlı", "Aç"],
              correct: 0,
            },
            {
        ...
        },
        {
          ...
          questions: [
            ...
            {
              q: "Masada elma armut ve muz var.",
              options: [
                "Masada elma, armut ve muz var.",
                "Masada elma armut ve muz var?",
                "Masada Elma Armut ve Muz var.",
              ],
              correct: 0,
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            ...
            {
              q: "İstiklal Marşı Mehmet Akif Ersoy tarafından yazılmıştır.",
              correct: true,
            },
            { q: "Bayrağımızda ay ve yıldız vardır.", correct: true },
            {
              q: "Milli marş söylenirken saygı göstermek önemlidir.",
              correct: true,
            },
            {
        ...
        },
        {
          ...
          sentences: [
            {
              text: "İstiklal Marşı’nın yazarı Mehmet Akif {blank}.",
              answer: "Ersoy",
              options: ["Ersoy", "yıldız", "saygı", "vatan"],
            },
            {
              text: "Bayrağımızda ay ve {blank} vardır.",
              answer: "yıldız",
              options: ["Ersoy", "yıldız", "saygı", "vatan"],
            },
            {
              text: "Milli marş söylenirken {blank} göstermek önemlidir.",
              answer: "saygı",
              options: ["Ersoy", "yıldız", "saygı", "vatan"],
            },
            {
              text: "İstiklal Marşı bağımsızlık ve {blank} sevgisini anlatır.",
              answer: "vatan",
              options: ["Ersoy", "yıldız", "saygı", "vatan"],
            },
          ],
  ...
  "29": {
      ...
      activities: [
        {
          ...
          questions: [
            {
              q: "Zeynep her akşam birkaç sayfa kitap okur. Yeni kelimeler öğrenir ve okuduklarını annesine anlatır.",
              options: [
                "Kayıp Oyuncak",
            ...
            {
              q: "Mert yere düşen plastik şişeyi aldı. Geri dönüşüm kutusuna attı. Bahçenin temiz kalmasına yardım etti.",
              options: ["Bahçede Temizlik", "Yeni Bisiklet", "Kırmızı Elma"],
              correct: 0,
            },
            {
              q: "Elif sınıfa yeni gelen arkadaşının yalnız kaldığını fark etti. Yanına gidip onunla oyun oynadı.",
              options: ["Uçan Balon", "Deniz Kıyısı", "Yeni Arkadaşa Yardım"],
              correct: 2,
            },
            {
              q: "Ali her gün biraz para biriktirdi. Bir süre sonra istediği kitabı alacak kadar parası oldu.",
              options: ["Sınıf Gezisi", "Birikim Yapmak", "Kayıp Kalem"],
              correct: 1,
            },
            {
            ...
            {
              q: "Çocuklar sınıf panosunu birlikte hazırladı. Biri resimleri kesti, biri yazıları yapıştırdı. İş kısa sürede bitti.",
              options: ["Sessiz Oda", "Tatil Hazırlığı", "Birlikte Çalışmak"],
              correct: 2,
            },
            {
              q: "Efe güneş panelinin oyuncak arabayı çalıştırdığını gördü. Güneş ışığının enerjiye dönüşebildiğini öğrendi.",
              options: ["Kış Uykusu", "Güneş Enerjisi", "Renkli Kalemler"],
              correct: 1,
            },
            {
              q: "Pelin korktuğu gölgenin aslında sandalyedeki hırka olduğunu fark etti. Korkusunun nedenini anlayınca rahatladı.",
              options: [
                "Karanlıktaki Gölge",
                "Lezzetli Yemek",
                "Parktaki Kuşlar",
    ...
    ulkemiOgreniyorum: {
      title:
        "Sandık 29: Güneydoğu Anadolu Bölgesi: Tarih, Taş Evler ve Sıcak Ovalar",
      activities: [
        {
          type: "info",
          ...
          infoImages: [
            {
              src: "/turkce-hazinem/29.etkinlik1.png",
        ...
        },
        {
          ...
          questions: [
            ...
            {
              q: "Güneydoğu Anadolu Türkiye’nin kuzeyindedir.",
              correct: false,
            },
            {
              q: "Fırat ve Dicle bölge için önemli nehirlerdir.",
              correct: true,
            },
          ],
        },
  ...
  "30": {
    ...
    ulkemiOgreniyorum: {
      title:
        "Sandık 30: Geleceği Tasarlayanlar: Canan Dağdeviren ve Alper Gezeravcı",
      activities: [
        {
          type: "info",
        ...
        },
        {
          ...
          sentences: [
            {
              text: "Canan Dağdeviren sağlık {blank} üzerine çalışır.",
              answer: "teknolojileri",
              options: [
                "teknolojileri",
                "astronotudur",
                "şekillendirmeye",
            ...
            {
              text: "Alper Gezeravcı Türkiye’nin uzaya giden ilk {blank}.",
              answer: "astronotudur",
              options: [
                "teknolojileri",
                "astronotudur",
            ...
            {
              text: "Bilim ve teknoloji geleceği {blank} yardım eder.",
              answer: "şekillendirmeye",
              options: [
                "teknolojileri",
                "astronotudur",
                "şekillendirmeye",
            ...
            {
              text: "Merak etmek, öğrenmenin önemli bir {blank}.",
              answer: "başlangıcıdır",
              options: [
                "teknolojileri",
                "astronotudur",
                "şekillendirmeye",
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            ...
            {
              q: "Türk kahvesi sofra kültürümüzle bağlantılı değildir.",
              correct: false,
            },
        ...
        },
        {
          ...
          sentences: [
            {
              text: "Marmara Bölgesi’nde {blank} Boğazı bulunur.",
              answer: "İstanbul",
              options: ["İstanbul", "Zafer", "not", "sofra"],
            },
            {
              text: "30 Ağustos {blank} Bayramı’dır.",
              answer: "Zafer",
            ...
            {
              text: "Atatürk kitap okurken {blank} alırdı.",
              answer: "not",
              options: ["İstanbul", "Zafer", "not", "sofra"],
            },
            {
              text: "Misafire ikram etmek {blank} kültürünün parçasıdır.",
              answer: "sofra",
              options: ["İstanbul", "Zafer", "not", "sofra"],
            },
          ],
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            ...
            {
              q: "Seksek geleneksel çocuk oyunlarından biridir.",
              correct: true,
            },
            { q: "Atatürk plansız çalışmayı severdi.", correct: false },
            {
              q: "Cahit Arf matematik alanında önemli bir isimdir.",
              correct: true,
            },
          ],
        },
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            ...
            {
              q: "Çiçek satan kişi",
              options: ["Çiçekli", "Çiçeklik", "Çiçekçi"],
              correct: 2,
            },
            {
              q: "Şekeri olmayan çay",
              options: ["Şekersiz çay", "Şekerli çay", "Şekerlik"],
              correct: 0,
            },
            {
              q: "Tuz koyulan kap",
              options: ["Tuzlu", "Tuzsuz", "Tuzluk"],
              correct: 2,
            },
          ],
        },
        {
          ...
          sentences: [
            {
              text: "Ali top oynadı. Kim? {blank} Ne yaptı? {blank}",
              answer: ["Ali", "oynadı"],
              options: [
                "Ali",
                "oynadı",
            ...
            {
              text: "Kedi süt içti. Kim ya da ne? {blank} Ne yaptı? {blank}",
              answer: ["Kedi", "içti"],
              options: [
                "Ali",
                "oynadı",
            ...
            {
              text: "Öğretmen ders anlattı. Kim? {blank} Ne yaptı? {blank}",
              answer: ["Öğretmen", "anlattı"],
              options: [
                "Ali",
                "oynadı",
                "Kedi",
            ...
            {
              text: "Kuş uçtu. Kim ya da ne? {blank} Ne yaptı? {blank}",
              answer: ["Kuş", "uçtu"],
              options: [
                "Ali",
                "oynadı",
    ...
    ulkemiOgreniyorum: {
      ...
      activities: [
        ...
        },
        {
          ...
          sentences: [
            {
              text: "Başkent Ankara {blank} Anadolu Bölgesi’ndedir.",
              answer: "İç",
              options: ["İç", "Ankara", "29", "çay"],
            },
            {
              text: "Anıtkabir {blank} şehrindedir.",
              answer: "Ankara",
            ...
            {
              text: "Cumhuriyet {blank} Ekim’de kutlanır.",
              answer: "29",
              options: ["İç", "Ankara", "29", "çay"],
            },
            {
              text: "Karadeniz’de {blank} ve fındık yetişir.",
              answer: "çay",
              options: ["İç", "Ankara", "29", "çay"],
            },
          ],
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            ...
            {
              q: "Birlikte çalışmak daha etkilidir.",
              options: [
                "Damlaya damlaya göl olur.",
                "Bir elin nesi var, iki elin sesi var.",
                "Ağaç yaşken eğilir.",
            ...
            {
              q: "Alışkanlıklar küçük yaşta daha kolay kazanılır.",
              options: [
                "Damlaya damlaya göl olur.",
                "Bir elin nesi var, iki elin sesi var.",
                "Ağaç yaşken eğilir.",
            ...
            {
              q: "Gereksiz görünen şeyler bir gün işe yarayabilir.",
              options: [
                "Damlaya damlaya göl olur.",
                "Bir elin nesi var, iki elin sesi var.",
                "Ağaç yaşken eğilir.",
        ...
        },
        {
          ...
          questions: [
            ...
            {
              q: "Kitap okumak kelime bilgimizi geliştirir.",
              options: ["Konu", "Ana fikir"],
              correct: 1,
            },
            {
              q: "Çevre temizliği",
      ...
      activities: [
        {
          ...
          questions: [
            ...
            {
              q: "Alper Gezeravcı Türkiye’nin uzaya giden ilk astronotudur.",
              correct: true,
            },
            {
              q: "Göbeklitepe Güneydoğu Anadolu Bölgesi’ndedir.",
              correct: true,
            },
          ],
        },
        {
          ...
          sentences: [
            {
              text: "Türkiye’nin üç tarafı {blank} çevrilidir.",
              answer: "denizlerle",
              options: [
                "denizlerle",
                "bayramdır",
            ...
            {
              text: "23 Nisan çocuklara armağan edilen bir {blank}.",
              answer: "bayramdır",
              options: [
                "denizlerle",
                "bayramdır",
            ...
            {
              text: "Ankara {blank} Anadolu Bölgesi’ndedir.",
              answer: "İç",
              options: [
                "denizlerle",
                "bayramdır",
      ...
      activities: [
        ...
        },
        {
          ...
          questions: [
            ...
            {
              q: "Hangi cümle doğru yazılmıştır?",
              options: ["Bu kitap senin mi?", "Bu kitap seninmi?"],
              correct: 0,
            },
            {
              q: "Hangi cümle doğru yazılmıştır?",
            ...
            {
              q: "Hangi cümle doğru yazılmıştır?",
              options: ["Elif kitap okudu.", "Elif okudu kitap."],
              correct: 0,
            },
            {
              q: "Hangi cümle doğru yazılmıştır?",
              options: ["Ben 3. sınıfa geçtim.", "Ben 3 sınıfa geçtim."],
              correct: 0,
            },
            {
              q: "Hangi cümle doğru yazılmıştır?",
              options: [
                "Masada kalem, silgi ve defter var.",
                "Masada kalem silgi ve defter var.",
              ],
              correct: 0,
            },
        ...
        },
        {
          ...
          questions: [
            {
              q: "Yaz geldi. Buradaki “yaz” ne anlama gelir?",
              options: ["Mevsim", "Yazı yazmak"],
              correct: 0,
            },
            {
              q: "Defterine yaz. Buradaki “yaz” ne anlama gelir?",
              options: ["Mevsim", "Yazı yazmak"],
              correct: 1,
            },
            {
              q: "Bahçedeki gül çok güzel kokuyor. Buradaki “gül” ne anlama gelir?",
              options: ["Çiçek", "Gülmek"],
              correct: 0,
            },
            {
              q: "Bana bakıp gül. Buradaki “gül” ne anlama gelir?",
              options: ["Çiçek", "Gülmek"],
              correct: 1,
            },
            {
              q: "Sıcak çay içtim. Buradaki “sıcak” nasıl kullanılmıştır?",
              options: ["Gerçek anlam", "Mecaz anlam"],
              correct: 0,
            },
            {
              q: "Beni sıcak karşıladı. Buradaki “sıcak” nasıl kullanılmıştır?",
              options: ["Gerçek anlam", "Mecaz anlam"],
              correct: 1,
            },
          ],
...
export const CHEST_DATA = [
  { id: 1, title: "Büyük ve Küçük Harfler", category: "Giriş Seviyesi", questions: 6 },
  { id: 2, title: "Hece Kavramı", category: "Giriş Seviyesi", questions: 6 },
  { id: 3, title: "Alfabe ve Harf Bilgisi", category: "Giriş Seviyesi", questions: 6 },
  { id: 4, title: "Harften Cümleye Geçiş (Harf-Hece-Kelime-Cümle ilişkisi)", category: "Giriş Seviyesi", questions: 6 },
  { id: 5, title: "Alfabetik Sıralama (Sözlük sırası)", category: "Giriş Seviyesi", questions: 6 },
  { id: 6, title: "Zıt Anlamlı Kelimeler", category: "Giriş Seviyesi", questions: 6 },
  { id: 7, title: "Eş Anlamlı Kelimeler", category: "Giriş Seviyesi", questions: 6 },
  { id: 8, title: "Sesteş (Eş Sesli) Kelimeler", category: "Giriş Seviyesi", questions: 6 },
  { id: 9, title: "Nokta (.) ve Virgül (,) Kullanımı", category: "Giriş Seviyesi", questions: 6 },
  { id: 10, title: 'Soru İşareti (?) ve "mi" Soru Ekinin Yazımı', category: "Giriş Seviyesi", questions: 6 },
  { id: 11, title: "Ünlem İşareti (!) ve Temel Noktalama Kuralları", category: "Orta Seviye", questions: 7 },
  { id: 12, title: "Özel İsimler ve Büyük Harflerin Kullanımı", category: "Orta Seviye", questions: 7 },
  { id: 13, title: "Kelimelerin Çağrışımları / Kelime Bilgisi", category: "Orta Seviye", questions: 7 },
  { id: 14, title: "Sözlük Anlamı (Kelimelerin anlamını bulma)", category: "Orta Seviye", questions: 7 },
  { id: 15, title: "Anlamlı ve Kurallı Cümle Yapısı", category: "Orta Seviye", questions: 7 },
  { id: 16, title: "Soru Oluşturalım (Soru sorma becerisi)", category: "Orta Seviye", questions: 7 },
  { id: 17, title: "Yazımı Yanlış Kelimeler (İmla kuralları)", category: "Orta Seviye", questions: 7 },
  { id: 18, title: "Konuşma Çizgisi (—) ve Kesme İşareti (')", category: "Orta Seviye", questions: 7 },
  { id: 19, title: "Cümle Tamamlama (Boşluk doldurma mantığı)", category: "Orta Seviye", questions: 7 },
  { id: 20, title: "Anlam İlişkisi (Kelimeler ve kavramlar arası bağlar)", category: "İleriye Geçiş", questions: 8 },
  { id: 21, title: "Sebep - Sonuç İfadeleri", category: "İleriye Geçiş", questions: 8 },
  { id: 22, title: "Bağlaçlar (İçin - Fakat - Çünkü gibi ifadeler)", category: "İleriye Geçiş", questions: 8 },
  { id: 23, title: "Hayvan İsimleri ve Tekil - Çoğul Kavramı", category: "İleriye Geçiş", questions: 8 },
  { id: 24, title: "Zaman Kavramı (Cümlede zaman bildiren ifadeler)", category: "İleriye Geçiş", questions: 8 },
  { id: 25, title: "Önem Belirten İfadeler", category: "İleriye Geçiş", questions: 8 },
  { id: 26, title: "Hayal Ürünü İfadeler (Gerçek vs. Fantastik)", category: "Zor Seviye / Ustalar", questions: 10 },
  { id: 27, title: "Atasözleri ve Deyimler", category: "Zor Seviye / Ustalar", questions: 10 },
  { id: 28, title: "Karşılaştırma Cümleleri", category: "Zor Seviye / Ustalar", questions: 10 },
  { id: 29, title: "Olayları Sıralama (Oluş sırası)", category: "Zor Seviye / Ustalar", questions: 10 },
  { id: 30, title: "Duygusal, Abartılı ve Farklı Düşünmeye Yönlendiren İfadeler", category: "Zor Seviye / Ustalar", questions: 10 },
];
