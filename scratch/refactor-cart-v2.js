...
const originalLogicRegex = /const discountAmount = cartItems\.reduce\(\(total, item\) => \{.*?return total \+ itemDiscount;\n    \}, 0\);/s;
...
content = content.replace(originalLogicRegex, newLogic);
